...
test/Olve.SlimeRepublics.UnitTests/               # Unit tests (TUnit + Rocks)
test/Olve.SlimeRepublics.IntegrationTests/        # Integration tests (TUnit + Testcontainers)
...
```bash
# Local
dotnet run --project src/Olve.SlimeRepublics

# Kubernetes
helm install olve-slimerepublics helm/
```
...
| `Auth:Audience` | `olve-slimerepublics` | JWT audience |
...
# artifact-name=olve-slimerepublics-2026.3.28.42+cb9a99b-linux-x64
```
