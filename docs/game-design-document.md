...
- **Layer 2 — the commander.** Roughly twenty slimes, seen from above. You can scroll around the map and see what your slimes and buildings reveal. You have a resource pool that ticks in, bounties to place, and cooldown-gated interventions. You can communicate to your slimes and set visual waypoints, but you cannot force anyone to do anything. You have the best tactical overview of the game, with layer 1's view too narrow and layer 3's view too aggregated and broad.
