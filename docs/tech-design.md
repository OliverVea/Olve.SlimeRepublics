...
- **One game server owns one game world.** A *tile* is one slime's space; a *section* is an n×n
  block of tiles; a *world* is the set of sections that forms one board. A world lives entirely in
