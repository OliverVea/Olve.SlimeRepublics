...
/**
 * Instantiates a new {@link OlveSlimeRepublicsClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createOlveSlimeRepublicsClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<OlveSlimeRepublicsClient>(requestAdapter, pathParameters, OlveSlimeRepublicsClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface OlveSlimeRepublicsClient extends BaseRequestBuilder<OlveSlimeRepublicsClient> {
    /**
     * The api property
     */
 ...
 */
export const OlveSlimeRepublicsClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const OlveSlimeRepublicsClientNavigationMetadata: Record<Exclude<keyof OlveSlimeRepublicsClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
