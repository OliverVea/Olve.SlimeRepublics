...
import {
  createOlveSlimeRepublicsClient,
  type OlveSlimeRepublicsClient,
} from "./api/olveSlimeRepublicsClient.js";
...
export function createClient(
  ...
  return createOlveSlimeRepublicsClient(adapter);
}
