...
const REFRESH_KEY = "olve-slimerepublics.oidc.refresh";
const USER_KEY = "olve-slimerepublics.oidc.user";
const PKCE_KEY = "olve-slimerepublics.oidc.pkce"; // sessionStorage: survives the redirect round-trip
