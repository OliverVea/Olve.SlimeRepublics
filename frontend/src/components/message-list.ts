...
import type { OlveSlimeRepublicsClient } from "../api/olveSlimeRepublicsClient.js";
...
export class MessageList extends BaseElement {
  ...
  #client: OlveSlimeRepublicsClient | null = null;
  ...
  set client(value: OlveSlimeRepublicsClient) {
    this.#client = value;
